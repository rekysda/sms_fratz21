...
class Cover_Rap_CRUD extends CI_Controller
{
  ...
  public function index(){
    ...
    $this->load->view('Cover_rap_CRUD/index',$data);
  ...
  public function show(){
    ...
    if($this->input->post('siswa_check[]',TRUE) || $this->input->post('semester',TRUE)){
      ...
      if(count($this->input->post('siswa_check[]',TRUE))==0){
        ...
        redirect('Cover_Rap_CRUD');
      }

      $data['title'] = 'Halaman Cover Rapor';
      ...
      $data['kelas_id'] = $this->input->post('kelas_id',TRUE);
        ...
        $this->load->view('templates/sidebar',$data);
        $this->load->view('templates/topbar',$data);
        $this->load->view('Cover_rap_CRUD/cover',$data);
        $this->load->view('templates/footer');
