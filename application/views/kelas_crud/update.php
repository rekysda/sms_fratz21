              ...
              <div class="form-group row">
                <div class="col-sm-6">
                  ...
                  <select name="kelas_program_id" id="kelas_program_id" class="form-control form-control-sm">
                    <?php
                    $_selected = set_value('kelas_program_id', $kelas_update['kelas_program_id']);
                ...
                <div class="col-sm">
                  ...
                  <input type="text" class="form-control form-control-sm" id="kelas_nama" required name="kelas_nama" value="<?= set_value('kelas_nama', $kelas_update['kelas_nama']) ?>">
                  ...
                  <input type="text" class="form-control form-control-sm" id="kelas_nama_singkat" name="kelas_nama_singkat" required value="<?= $kelas_update['kelas_nama_singkat']; ?>">
