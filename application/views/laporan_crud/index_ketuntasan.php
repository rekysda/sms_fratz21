      ...
      <div class="row">
        <div class="col-lg">
          <div class="p-5 overflow-auto">
            ...
            <form class="user" action="<?= base_url('Laporan_CRUD/index_ketuntasan_show') ?>" method="POST">
              ...
              <div class="form-group row">
                <?php if($waka == 1): ?>
                  <div class="col-sm mb-sm-0">
                    <label><b><u>Mapel:</u></b></label>
                    <div id="mapel_ketuntasan">

                    </div>
                  </div>
                  <div class="col-sm mb-sm-0">
                    <label><b><u>Tampilkan Detail?:</u></b></label><br>
                    <select class="form-control form-control-sm" name="detail_tampil">
