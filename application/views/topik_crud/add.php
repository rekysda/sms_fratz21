                ...
                <div class="col-lg">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Tambah KD Pengetahuan dan Keterampilan</h1>
                        </div>
                        ...
                        <form class="user" method="post" action="<?= base_url('Topik_CRUD/proses_add'); ?>">
                            ...
                            <div class="form-group row">
                                <div class="col-sm mb-3 mb-sm-0">
                                  ...
                                  <textarea rows="4" name="topik_nama" class="form-control mb-3" required></textarea>

                                  <h6><u>KD Keterampilan:</u></h6>
                                  <textarea rows="4" name="topik_nama_ket" class="form-control mb-3" required></textarea>
