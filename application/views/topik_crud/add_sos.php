                ...
                <div class="col-lg">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Tambah KD Sosial</h1>
                        </div>

                        <?= $this->session->flashdata('message'); ?>

                        <form class="user" method="post" action="<?= base_url('Topik_CRUD/proses_add_sos'); ?>">
                            <input type="hidden" name="mapel_id" value="<?= $mapel_id ?>">
                            <div class="form-group row">
                                <div class="col-sm mb-3 mb-sm-0">

                                  <h6><u>KD Sosial:</u></h6>
                                  <textarea rows="4" name="sosial_nama" class="form-control mb-3" required></textarea>

                                    <!-- <input type="text" class="form-control" id="topik_nama" name="topik_nama" placeholder="Nama KD Pengetahuan" required> -->
                                  <h6><u>Urutan KD:</u></h6>
                                  <input type="number" class="form-control" id="sosial_urutan" name="sosial_urutan" required>
                                </div>
                            </div>
                            <div class="form-group row">
